...
Det som kan få en implementation av hashCode att bli inkorrekt, är bland annat att hashCode inte genererar samma data för objekt som bör vara lika varje gång. 
...
Arrays och egengjorda klasser fungerar annorlunda, standardimplementation av hashCode för dessa baseras på minnesadressen snarare än innehåll
vilket gör den oanvändbar i de flesta sammanhang.
